...
class BPlatform:
    ...
    def reload_mat(self):
        self.result_f_mat = self.b_area_drawer.get_full_result_mat(self.source_f_mat, self.b_figure_worker.get_figures(),self.dot_radius,self.line_width)
    ...
    def add_point(self, x_co, y_co):
        self.selected_figure = self.b_figure_worker.actived_figure().add_point_v2(x_co,y_co)
